...
export const Booking = () => {
  ...
  return (
    <>
      ...
      <div className="md:sticky md:bottom-0 md:py-0 py-10 flex justify-center">
        <div className="mx-auto dark:text-black">
          ...
          <div className="relative">
            <div className="z-10 absolute md:top-1/2 bottom-[-10px] md:left-0 left-10 transform -translate-y-1/2">
              <button
                className="border-2 dark:border-slate-800 bg-gray-700 w-[75px] h-[75px] rounded-lg"
            ...
            <div className="z-10 absolute md:top-1/2 bottom-[-10px] md:right-0 right-10 transform -translate-y-1/2">
              <button
                className="border-2 dark:border-slate-800 bg-sky-600 w-[75px] h-[75px] rounded-lg"
