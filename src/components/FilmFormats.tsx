    ...
    <div>
      <div className="bg-white m-5 sm:py-10 py-5 lg:mx-12 rounded drop-shadow-md">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          <h2 className="text-center lg:text-2xl sm:text-xl text-base font-semibold leading-8 text-gray-900">
          ...
          <div className="flex flex-wrap justify-center sm:gap-x-10 gap-x-5 sm:gap-y-12 gap-y-5 sm:mt-10 mt-5">
            {filmFormats.map((format: string, index: number) => (
              <img
                key={index}
                className="md:h-[48px] md:w-[158px] sm:h-[40px] sm:w-[120px] h-[27px] w-[81px]"
                src={format}
                alt="Transistor"
              />
            ))}
